...
//to other javascript in other files. It is not required.
    ...
    //1.3 Map the Visual channel color
	...
	var ordinal = d3.scaleOrdinal()
      ...
      .range(d3.schemeSet3); //use d3 Color Scheme #3 as output colors
        ...
        //Modify code, add to make the points a variable
       var points = chart.append('g') //save all scatterplot points into "points"
        .selectAll("circle")
        .data(data)
        .join("circle")
        //take this out (maybe)
       // .append("circle") //map data attributes to channels 
            ...
            //modifyed added code (this is added)
